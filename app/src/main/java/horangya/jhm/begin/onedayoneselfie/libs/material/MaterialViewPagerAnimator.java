package horangya.jhm.begin.onedayoneselfie.libs.material;
...
import static horangya.jhm.begin.onedayoneselfie.libs.material.Utils.canScroll;
import static horangya.jhm.begin.onedayoneselfie.libs.material.Utils.colorWithAlpha;
import static horangya.jhm.begin.onedayoneselfie.libs.material.Utils.dpToPx;
import static horangya.jhm.begin.onedayoneselfie.libs.material.Utils.getTheVisibileView;
import static horangya.jhm.begin.onedayoneselfie.libs.material.Utils.minMax;
import static horangya.jhm.begin.onedayoneselfie.libs.material.Utils.scrollTo;
import static horangya.jhm.begin.onedayoneselfie.libs.material.Utils.setBackgroundColor;
import static horangya.jhm.begin.onedayoneselfie.libs.material.Utils.setElevation;
import static horangya.jhm.begin.onedayoneselfie.libs.material.Utils.setScale;
...
public class MaterialViewPagerAnimator {
    ...
    public void restoreScroll(final float scroll) {
        //try to scroll up, on a looper to wait until restored
        new Handler(Looper.getMainLooper()).postDelayed(new Runnable() {
            @Override
            public void run() {
